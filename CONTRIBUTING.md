...
4. If you changed the dependencies in `pyproject.toml`, or `requirements-dev.in`, regenerate the lockfiles and commit them:
...
This repository uses two separate workflows for CI/CD and release management:
